...
const AddEducation = ({
    ...
    const [isNotCurrent, setIsCurrent] = useState(false)
    ...
    return (
        <>
            ...
            <p className="lead">
                <LibraryBooksIcon/> Add any school, bootcamp, etc that
                you have attended
            </p>
            ...
            <form className="form" onSubmit={e=> onSubmit(e)}>
                ...
                <div className="form-group">
                    ...
                    value={fieldofstudy} onChange ={e => onChange(e)} name="fieldofstudy" />
                </div>
                <div className="form-group">
                    <h4>From Date</h4>
